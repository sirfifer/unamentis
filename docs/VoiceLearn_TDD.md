...
# Technical Design Document: VoiceLearn iOS
...
VoiceLearn is an iOS application for extended (60-90+ minute) voice-based educational conversations with AI. The system enables:
...
This TDD provides a complete blueprint for building VoiceLearn. Every component is designed to be:
