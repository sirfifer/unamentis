...
const MOCK_IMAGES = [
  ...
  {
    id: '7',
    url: 'https://images.unsplash.com/photo-1531297461136-82lw8u8z5g2',
    title: 'Technology',
    author: 'Alex Knight',
  },
  {
...
export const MediaPicker: React.FC<MediaPickerProps> = ({ onSelect, onClose }) => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const filtered = MOCK_IMAGES.filter(
        (img) =>
        ...
        <div className="p-6 border-b border-slate-800 flex justify-between items-center bg-slate-900/50">
          <div>
            ...
            <p className="text-slate-400 text-sm">
              Find free-to-use images from the creative commons.
            </p>
          </div>
          <button
            onClick={onClose}
